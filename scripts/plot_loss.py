...
def main(history_path: str, output_dir: str):
    history_path, output_dir = Path(history_path), Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
    log_history = json.loads(history_path.read_text())

    total_df = _to_dataframe(log_history,
    ...
    mlm_df = _to_dataframe(log_history,
